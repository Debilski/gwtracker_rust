    ...
    I::Item: Sample,
{
    TakeWithFade {
        ...
        duration_per_sample: TakeWithFade::get_duration_per_sample(&input),
        input,
        remaining_duration: duration,
        requested_duration: duration,
        fade_duration: fade_duration,
        filter: Some(DurationFilter::FadeOut),
    }
}
        ...
        I::Item: Sample,
    {
        ...
        match self {
            FadeOut => {
                ...
                let divisor = if remaining <= fade_duration {
                    fade_duration
                } else {
                    remaining
                };
...
impl<I> Iterator for TakeWithFade<I>
where
    I: Source,
    I::Item: Sample,
{
...
impl<I> Source for TakeWithFade<I>
where
    I: Iterator + Source,
    I::Item: Sample,
{
